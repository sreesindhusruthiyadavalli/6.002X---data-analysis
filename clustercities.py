#links
#http://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-00sc-introduction-to-computer-science-and-programming-spring-2011/unit-3/lecture-21-using-graphs-to-model-problems-part-1/lec21.py
...
def test():
    points = buildCityPoints('C:\Users\lenovo\Canopy\scripts\ProblemSet6\ProblemSet6\cityTemps.txt', False)
